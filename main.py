...
class Panel(TabbedPanel):
    ...
    def button_press(self):
        ...
        req = UrlRequest(self.urlT.format(coin), on_success=self.got_json, on_failure=self.got_erro,
                         on_error=self.got_erro)
    ...
    def buttont_press(self):
        ...
        req = UrlRequest(self.urlT.format(coin), on_success=self.got_jsonT, on_failure=self.got_erro,
                         on_error=self.got_erro)
